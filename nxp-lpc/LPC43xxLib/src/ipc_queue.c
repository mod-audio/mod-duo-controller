...
const cmdToken INVALID_CMD_TOKEN = { .cmdClass.rawCmdWord = 0xFFFFFFFF };
const rdCmd INVALID_RD_CMD = { .cmdClass.rawCmdWord = 0xFFFFFFFF };
const wrCmd INVALID_WR_CMD = { .cmdToken.cmdClass.rawCmdWord = 0xFFFFFFFF, 0xFFFFFFFF };
...
const msgToken 	INVALID_MSG_TOKEN = { .msgClass.rawMsgWord = 0xFFFFFFFF };
const srvMsg 	INVALID_SRV_MSG = { .msgClass.rawMsgWord = 0xFFFFFFFF };
const rdMsg 	INVALID_RD_MSG = { .msgToken.msgClass.rawMsgWord = 0xFFFFFFFF, 0xFFFFFFFF };
const rdStsMsg 	INVALID_RD_STS_MSG = { .msgClass.rawMsgWord = 0xFFFFFFFF };
const wrStsMsg 	INVALID_WR_STS_MSG = { .msgClass.rawMsgWord = 0xFFFFFFFF };
