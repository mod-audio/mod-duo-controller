...
void USB_Init(uint8_t corenum)
{
    ...
    */
    ...
    LPC_USB->USBClkCtrl = 0x12;     /* Dev, OTG, AHB clock enable */
    while ((LPC_USB->USBClkSt & 0x12) != 0x12);
#endif
...
static const uint32_t DDAdr[2] = { DD_NISO_ADR, DD_ISO_ADR };
static const uint32_t DDSz [2] = { 16,          20         };
