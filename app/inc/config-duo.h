...
#define GLCD0_BACKLIGHT_PIN     25
#define GLCD1_BACKLIGHT_PORT    1
#define GLCD1_BACKLIGHT_PIN     26

// Switcher ports and pins definitions
// The switcher is used to select the display
#define SWITCHER_DIR_PORT       0
#define SWITCHER_DIR_PIN        17
#define SWITCHER_CH0_PORT       0
#define SWITCHER_CH0_PIN        9
#define SWITCHER_CH1_PORT       0
#define SWITCHER_CH1_PIN        18
