...
#define SERIAL1_RX_PORT         4
#define SERIAL1_RX_PIN          29
#define SERIAL1_RX_FUNC         3
#define SERIAL1_RX_BUFF_SIZE    32
#define SERIAL1_TX_PORT         4
#define SERIAL1_TX_PIN          28
#define SERIAL1_TX_FUNC         3
...
#define LED0_PINS           {1, 19, 1, 18, 1, 20}
#define LED1_PINS           {1, 25, 1, 24, 1, 26}
...
#define GLCD_COMMON_CONFIG  .ssp_module = LPC_SSP0, .ssp_clock = 100000, \
                            ...
                            .cd_port = 0, .cd_pin = 22, \
                            .rst_port = 0, .rst_pin = 11

#define GLCD0_CONFIG    { GLCD_COMMON_CONFIG, \
                          .cs_port = 0, .cs_pin = 16, \
                          .backlight_port = 1, .backlight_pin = 30 },

#define GLCD1_CONFIG    { GLCD_COMMON_CONFIG, \
                          .cs_port = 0, .cs_pin = 10, \
                          .backlight_port = 1, .backlight_pin = 31 },

// Selector ports and pins definitions
#define SELECTOR_DIR_PINS       {0, 26}
#define SELECTOR_CHANNELS_PINS  {0, 29, 0, 30}
...
#define FOOTSWITCH0_PINS    {1, 22}
#define FOOTSWITCH1_PINS    {1, 23}
...
#define ENCODER0_PINS       {1, 1, 1, 8, 1, 4}
#define ENCODER1_PINS       {0, 1, 0, 0, 1, 29}
...
#define WEBGUI_COMM_TX_BUFF_SIZE    32
