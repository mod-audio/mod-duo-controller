...
#define FOOTSWITCH_NAV_ID     BANKS_ID
...
#define ENUMERATED_1_COLOR          GREEN
#define ENUMERATED_2_COLOR          YELLOW
#define ENUMERATED_3_COLOR          BLUE
#define ENUMERATED_4_COLOR          CYAN
#define ENUMERATED_5_COLOR          MAGENTA
